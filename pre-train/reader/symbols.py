...
df = pd.read_csv("/home/users/huiqing_lin/scratch/DS_10283_2651/VCTK-Corpus/speaker-info.txt", sep="\s+", index_col=False)
seen_speakers = list(df["ID"].apply(str))
# print(f"len(seen_speakers): {len(seen_speakers)}")
